...
public class UsuariosBD {
    ...
    public static boolean loginUsuario(String username, String password) {
        ...
        try {
            ...
            ResultSet resultado = sentencia.executeQuery("SELECT * FROM alumnos WHERE username LIKE '" + username + "'");
    ...
    public static boolean crearUsuario() {
        ...
        try {
            ...
            System.out.print("Contraseña: ");
            String password = new String(System.console().readPassword());
            int resultado = sentencia.executeUpdate("INSERT INTO alumnos (username, password) VALUES ('" + usuario + "', '"
